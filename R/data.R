...
#'	\item{variant_information}{Unique variant identifier. Contains chromosome,
#'	position, ref and alt alleles and genome build. Named "variant_id" in
#'  original GTEx dataset'}
