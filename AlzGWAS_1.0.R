	...
	# Lectura de archvos de texto como tablas. Viene con un defecto, y es que algunos RS aparecen repetidos.
	...
	### Información de fármacos. Nota: aquí también hago análisis aleatorio, pero realmente no debería ser aplicable. Los genes falsos positivos ya se han retirado,
	...
	newResults = read.table("Resultados.tsv")

 	oldResults = read.table("Resultados_Old.tsv")
